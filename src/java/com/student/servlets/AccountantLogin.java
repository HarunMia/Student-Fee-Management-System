...
import com.student.dao.AccountantDao;
...
public class AccountantLogin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            request.getRequestDispatcher("navaccountant.xhtml").include(request, response);
            ...
            if (status) {
                ...
                request.getRequestDispatcher("accountanthome.xhtml").include(request, response);
            } else {
                out.println("<h1>Accountant Login Form</h1>");
                out.println("<p>Sorry, username or password error!</p>");
                request.getRequestDispatcher("AccountantLoginForm.xhtml").include(request, response);
            }
            out.println("</div>");
